...
public class CorrectorMasterChef {
    ...
    public static void main(String[] args) {
        ...
        boolean prinEntrada = containsAny(S, "principiante", "entrada") || (S.contains("entrada") && S.contains("sirv"));
        ...
        boolean interPrincipal = containsAny(S, "intermedio", "principal") || (S.contains("principal") && S.contains("sirv"));
