...
public class Main {
    public static void main(String[] args) {
        ...
        Rectangular rectangular1 = new Rectangular("diana 1", Nivel.DIFICIL, puntajes1, 32, 3);
        Circular circular1 = new Circular("diana 2", Nivel.FACIL, puntajes2);
        Cuadrada cuadrada1 = new Cuadrada("diana 3", Nivel.MEDIO, puntajes3, 23 );
        ...
        b1.cantBeneficiosNoAcumulables();
        System.out.println(circular1.calcularArea());
        System.out.println( rectangular1.calcularArea());
        System.out.println( cuadrada1.calcularArea());
    }
}
